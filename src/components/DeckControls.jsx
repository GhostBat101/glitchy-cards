/**
 * DeckControls - Pure functional navigation and modulation dock styled in shades of #7f7f7f neutral gray.
...
export default function DeckControls({
  ...
  return (
    <div className="flex items-center justify-between gap-3 p-2 bg-[#222222]/90 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl w-full">
          ...
          <button
            ...
            className={`p-2 rounded-xl border transition-all ${
              isSpinning
                ...
                : 'bg-[#141414]/80 border-white/10 text-[#9e9e9e] hover:text-white'
            }`}
          >
